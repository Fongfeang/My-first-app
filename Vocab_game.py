...
def reset_game():
    ...
    st.session_state.ans3_val = ""  # เคลียร์ค่าช่องข้อ 3 (จุดที่ 2)
    st.session_state.ans4_val = ""  # เคลียร์ค่าช่องข้อ 4 (จุดที่ 2)
...
st.session_state.ans3_val = ans3  # (จุดที่ 7)
st.session_state.ans4_val = ans4  # (จุดที่ 7)
